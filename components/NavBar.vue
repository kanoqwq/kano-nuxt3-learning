    ...
    <a-row type="flex" justify="center">
      <a-col :span="19">
        <a-row type="flex" justify="space-between">
          <a-col :span="4">
            <NuxtLink to="/">
              <img style="margin-top: 12px" class="logo" alt="logo" src="/images/logo.png"/>
            </NuxtLink>
          </a-col>
          <a-col :span="15">
            ...
            <a-row type="flex" justify="space-around">
              <a-col>
                ...
                <a-dropdown v-else>
                  <div class="avatar">
                    ...
                    <icon name="ant-design:caret-down-filled"/>
                  </div>
                  <template #overlay>
                    <a-menu>
                      <a-menu-item>
              ...
              <a-col>
                <a-button @click="go" shape="round" type="primary" style="height: 40px;font-size: 16px">
                  <icon name="mdi:feather" style="margin-right: 4px;font-size: 16px;vertical-align: middle;"/>
                  写文章
                </a-button>
              </a-col>
            </a-row>
