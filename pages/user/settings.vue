        ...
        <a-col :span="17">
          <div class="setting-base">
            ...
            <div class="settings-list border-b">
              ...
              <div class="nickname">
                <a-input v-model:value="user.nickname" style="background-color: #F7F7F7;" :bordered="false"
                         placeholder="输入昵称"></a-input>
              </div>
            </div>
            <div class="settings-list border-b">
              <div class="item-line">
...
const beforeUpload = async (file) => {
  ...
  userInfoFetch({
    ...
    //更新用户信息
    useCookie('userInfo').value = data.value.data
    user.value = data.value.data
  })
  return [{url: data.value.data.avatar, title: data.value.data.fileName}]
}
