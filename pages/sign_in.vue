        ...
        <a-row>
          <a-col :span="12">
            <a-row class="login-left" type="flex" justify="end">
              ...
              <a-row>
                <a-button style="width: 250px;height: 45px" shape="round" size="large" type="primary">下载简书APP
                </a-button>
              ...
              <div class="login-form">
                ...
                <div class="form">
                  <a-form :model="formState">
                    ...
                    <a-form-item style="border-top: 1px solid #C8C8C8;">
                      ...
                      >
                        <template #prefix>
                          <icon name="ant-design:lock-filled"/>
                        </template>
                      </a-input>
                    </a-form-item>
                ...
                <div class="more-sign">
                  ...
                  <a-row type="flex" justify="center" style="margin-top: 30px">
                    <div>
                      <icon name="ant-design:weibo-outlined" style="color:#498AD5;font-size: 30px"/>
                    </div>
                    <div style="margin: 0 30px">
                      <icon name="ant-design:wechat-outlined" style="color:#498AD5;font-size: 30px"/>
                    </div>
                    <div>
                      <icon name="ant-design:qq-outlined" style="color:#498AD5;font-size: 30px"/>
                    </div>
                  </a-row>
                </div>
...
const login = async () => {
  ...
  const {data} = await loginFetch({method: 'POST', body: formState})
  if (data) {
