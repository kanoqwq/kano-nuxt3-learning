<template>
  ...
  <a-row type="flex" justify="center" style="background-color: #F9F9F9;min-height:100vh;padding-top: 66px">
    <a-col :span="15">
      <a-row>
        <a-col flex="auto" class="note-content">
          <div class="author-box">
            ...
            <div class="author-info">
              <NuxtLink>
                <a-avatar :size="44">
                  <template #icon>
                    <img :src="noteData.avatar?noteData.avatar:'/images/default-avatar.png'" alt="avatar">
                  </template>
                </a-avatar>
              </NuxtLink>
              <div class="author-des">
                <a-row type="flex" align="middle">
                  ...
                  <icon name="mdi:clover"  style="color: #00BB29"/>
                  <a-button style=" height: 22px;padding: 0 6px;font-size: 12px;margin-left: 6px" shape="round"
                            size="small" danger>关注
                  </a-button>
                  <span class="ip">IP属地：上海</span>
                </a-row>
                <a-row type="flex" align="middle" style="margin-top: 6px">
                  <span class="jsd-meta"><icon name="ion:diamond"/>136.0</span>
...
import {noteDetailFetch} from "~/composables/useHTTPFetch";
